// Package elevenlabs exposes ElevenLabs realtime WebSocket TTS.
package elevenlabs
...
import (
	...
	internal "github.com/caitunai/tts/internal/provider/elevenlabstts"
)

type Config = internal.Config

const ProviderName = "elevenlabs_tts"
