// Package qwenrealtime exposes Alibaba Cloud Qwen realtime WebSocket TTS.
...
import (
	...
	internal "github.com/caitunai/tts/internal/provider/qwenrealtime"
)

type Config = internal.Config

const ProviderName = "qwen_realtime_tts"
