// Package inworld exposes Inworld AI bidirectional WebSocket TTS.
package inworld
...
import (
	...
	internal "github.com/caitunai/tts/internal/provider/inworldtts"
)

type Config = internal.Config

const ProviderName = "inworld_tts"
